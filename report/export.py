...
# ---------------------------------------------------------------------------
# Style tokens — Pure Earth Wellness primary (green / #004F39)
# ---------------------------------------------------------------------------
COLOR_PRIMARY = "004F39"
COLOR_PRIMARY_DARK = "003F2E"
COLOR_PRIMARY_SOFT = "E0EAE7"
COLOR_SLATE = "595959"
COLOR_TEXT = "333333"
COLOR_ROW_ALT = "F2F6F5"
COLOR_WHITE = "FFFFFF"
COLOR_BORDER = "B8CEC8"
COLOR_KPI_VALUE = "003123"
...
def _apply_print_setup(ws, meta: Optional[dict] = None, landscape: bool = False):
    ...
    # Falls back to the company name from meta rather than a hardcoded
    # product name, so this stays correct for any white-labeled deployment.
    product = meta.get("product_name") or _company_from_meta(meta).get("name") or ""
...
_CHART_PALETTE_HEX = ["004F39", "2563EB", "15803D", "7C3AED", "0D9488", "F59E0B"]
